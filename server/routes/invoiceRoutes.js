...
router.get('/:orderId', auth, async (req, res) => {
  try {
    ...
    const invoice = {
      ...
      payableAmount: (order.payableAmount !== undefined && order.payableAmount !== null) ? order.payableAmount : Math.max(0, order.totalPrice - (order.walletUsed || 0) - (order.giftCard?.amountUsed || 0)),
